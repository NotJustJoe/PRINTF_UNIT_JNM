...
/*   Updated: 2021/03/17 17:57:25 by trofidal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	char cmedium1 = 48;							// CHAR //
	char cmedium2 = '0';
	char cmedium3 = 49;
	char cmedium4 = 120;
	char cmedium5 = 'b';
	char *smedium1 = "I am a little sneaky boy";		// STRINGS //
	char *smedium2 = "Yo0";
	...
	int pmedium4 = -19;
	int pmedium5 = -0;
	int dmedium1 = 0;				// INT D || INT I || INT U //
	int dmedium2 = 999999;
	int dmedium3 = 15489;
	int dmedium4 = -6196818;
	int dmedium5 = -0;
	int xmedium1 = 0;				// INT X || INT x //
	int xmedium2 = 19;
	int xmedium3 = 15489;
	int xmedium4 = -19;
	int xmedium5 = -0;
	...
	function("b%.3s, %30.sD:%s\n", smedium4, smedium5, smedium3);
	function("89417891\n");					//  _   __        
	function("961491\n");					// (_) / /        
	function("-1518\n");					//    / /   _ __  
	function("+15\n");						//   / /   | '_ \ 
	...
	function("b%98d, %-30dD:\n", dmedium4, CHAR_MIN);
	function("a%31d, %*d:>\n", INT_MIN, 20, dmedium5);
	function("a%31d, %*d:ddzedazdazd%%z%%d>\n", INT_MIN, 20, INT_MIN);
	function("89417891\n");						//  _   __  _ 
	function("961491\n");						// (_) / / (_)
	function("-1518\n");						//    / /   _ 
	function("+15\n");							//   / /   | |
	...
	function("b%98i, %-30iD:\n", dmedium4, CHAR_MIN);
	function("a%31i, %*i:>\n", INT_MIN, 20, dmedium5);
	function("a%31i, %*i:ddzedazdazi%%z%%i>\n", INT_MIN, 20, INT_MIN);
	function("89417891\n");						//  _   __        
	function("961491\n");						// (_) / /        
	function("-1518\n");						//    / /   _   _ 
	function("+15\n");							//   / /   | | | |
	...
	function("b%98u, %-30uD:\n", dmedium4, CHAR_MIN);
	function("a%31u, %*u:>\n", INT_MIN, 20, dmedium5);
	function("a%31u, %*u:ddzedazdazu%%u%%u>\n", INT_MIN, 20, INT_MIN);
	function("89417891\n");						//  _   __                   _       
	function("961491\n");						// (_) / /                  (_)      
	function("-1518\n");						//    / /  __  __  _ __ ___  _ _ __  
	function("+15\n");							//   / /   \ \/ / | '_ ` _ \| | '_ \ 
	function("0\n", INT_MIN);					//  / / _   >  <  | | | | | | | | | |
	function("%x\n", dmedium2);					// /_/ (_) /_/\_\ |_| |_| |_|_|_| |_|
	function("%x\n", dmedium3);
	function("%x\n", dmedium4);
	function("%x\n", INT_MAX);
	function("%x Hi i am\n", dmedium1);
	...
	function("b%98x, %-30xD:\n", dmedium4, CHAR_MIN);
	function("a%31x, %*x:>\n", INT_MIN, 20, dmedium5);
	function("a%31x, %*x:ddzedazdazx%%x%%x>\n", INT_MIN, 20, INT_MIN);
	function("89417891\n");						//  _   __ __   __
	function("961491\n");						// (_) / / \ \ / /
	function("-1518\n");						//    / /   \ V / 
	function("+15\n");							//   / /     > <  
